<div class="row">
    <div class="col-lg-12">
        <div class="card mb-3">
            <form class="validate1" action="brand/update/<?= $data['brand_id']; ?>" method="post" enctype="multipart/form-data" novalidate>
                <div class="card-header uppercase">
                    <div class="caption"><i class="ti-pencil-alt"></i> Edit Brand</div>
                    <div class="tools">
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <img src="uploads/brand/<?=$data['brand_img'];?>" style="height: 80px; widght:100px;"><br>
                                    <div>
                                        <input type="file" name="brand_img" onchange="readURL(this);" value="<?= $data['brand_img']; ?>">&nbsp;&nbsp;&nbsp;
                                        <img id="one" >
                                    </div>
                                </div>  
                            </div>
